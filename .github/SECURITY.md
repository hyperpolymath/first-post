...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/first-post/security/advisories/new)
...
- This repository (`hyperpolymath/first-post`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/first-post/security/advisories)
...
When using first-post, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/first-post/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/first-post/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/first-post/discussions) |
...
*Thank you for helping keep first-post and its users safe.* 🛡️
